...
function update(entity)
    ...
    or entityXMovementCollidesWithGroup(entity, 0, "BasketBallHoops", 0) or entityXMovementCollidesWithGroup(entity, 0, "BasketBallHoops", 1)
    ...
    or entityYMovementCollidesWithGroup(entity, 0, "BasketBallHoops", 0) or entityYMovementCollidesWithGroup(entity, 0, "BasketBallHoops", 1)
    ...
    or entityMovementCollidesWithGroup(entity, 0, "BasketBallHoops", 0) or entityMovementCollidesWithGroup(entity, 0, "BasketBallHoops", 1)
    ...
    if entityStaticCollidesWithGroup(entity, 0, "BasketBallHoops", 2)  and getEntityDeltaY(entity) > 0 then
        if timeScored <= 0 then
            print("score")
            timeScored = 1
        end
